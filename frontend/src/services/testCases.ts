...
const headerStorageTests: TestCase[] = [
  {
    ...
    description: 'Login using header storage configuration',
  ...
  {
    id: 'header-protected-valid',
    name: 'Access Protected with Valid Token',
    description: 'Access protected endpoint with valid X-Auth-Token header',
    category: 'header-storage',
  ...
  {
    id: 'header-protected-missing',
    name: 'Access Protected with Missing Header',
    description: 'Access protected endpoint without X-Auth-Token header, expects 401',
    category: 'header-storage',
    endpoint: '/header/protected',
    method: 'GET',
    expectedStatus: 401,
  ...
  {
    id: 'header-protected-malformed',
    name: 'Access Protected with Malformed Header',
    description: 'Access protected endpoint with wrong header format',
    category: 'header-storage',
    endpoint: '/header/protected',
    method: 'GET',
    headers: { 'X-Auth-Token': 'InvalidFormat' },
    expectedStatus: 401,
...
const cookieStorageTests: TestCase[] = [
  ...
  {
    id: 'cookie-protected-valid',
    name: 'Access Protected with Cookie',
    description: 'Access protected endpoint with access token cookie',
    category: 'cookie-storage',
  ...
  {
    id: 'cookie-protected-missing',
    name: 'Access Protected without Cookie',
    description: 'Access protected endpoint without access token cookie, expects 401',
    category: 'cookie-storage',
    endpoint: '/cookie/protected',
    method: 'GET',
    expectedStatus: 401,
